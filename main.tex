...
% 自定义颜色
\definecolor{primary_color}{RGB}{156, 12, 19}    % 山大红
\definecolor{secondary_color}{RGB}{202, 127, 131}

\newlength{\iconwidth}
\setlength{\iconwidth}{1.5em}                   % 设置 section 标题部分图标占用的宽度
\newcommand{\Cpp}{C\texttt{++}}                % 注释示例中会用到
...
% 学院
\newcommand{\school}{低空科学与工程学院 | School of Airspace Science and Engineering} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@mail.sdu.edu.cn}{youremail@mail.sdu.edu.cn}
        \hspace{4em}
        % 手机号
        \faPhone \quad  182-5555-0000
        % 别的联系方式，如微信、GitHub等
        \hspace{4em}
        \faGithub \quad \href{https://github.com/Marsllq/SDU-CV}{GitHub 项目地址}
    }
}

% 页面装饰：页眉、页脚和背景
\newcommand{\ResumePageDecor}{
    % 页眉：校标组合+学院名
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.2\textwidth]{images/sdu_logo_title.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/sdu_logo_bg.png}
        };
    \end{tikzpicture}
}
...
\begin{document}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        {\large \textbf{山东大学}}，本科 \hfill 2000年9月--2010年6月
        \begin{itemize}
            \item 你的学院，你的专业
        ...
        \vspace{0.5em}
        {\large \textbf{山东大学}}，硕士 \hfill 2010年9月--2020年6月
        \begin{itemize}
        ...
        \vspace{0.5em}
        {\large \textbf{山东大学}}，博士 \hfill 2020年9月--至今
        \begin{itemize}
            \item 你的学院，你的专业，你的导师姓名\ 职称
            \item \textbf{研究方向}：方向1、方向2、方向3、方向4\ 等。
        \end{itemize}
    ...
    \begin{minipage}[t]{0.2\textwidth}
        ...
        \doublebox{\includegraphics[width=\dimexpr\linewidth-8pt\relax]{images/avatar.png}}
    \end{minipage}
    ...
    \begin{minipage}[t]{0.6\textwidth}
        ...
        \setlength{\itemsep}{0.5em}
            \item 熟练使用 Python、Java、Rust 等编程语言。
    ...
    % 如有需要，可以添加额外的页面。每页开头调用一次 \ResumePageDecor。
    \newpage
    \ResumePageDecor
    
    % 竞赛经历
    \section[竞赛经历]{\makebox[\widthof{\faTrophy}][c]{\color{primary_color}{\faTrophy}}\quad 竞赛经历}
    \begin{table}[h!]
    ...
    % 技能特长
    \section[技能特长]{\makebox[\widthof{\faWrench}][c]{\color{primary_color}{\faWrench}}\quad 技能特长}
    \begin{itemize}
    ...
    % 其他
    \section[其他]{\makebox[\widthof{\faInfo}][c]{\color{primary_color}{\faInfo}}\quad 其他}
    \begin{itemize}
        \item 英语水平-CET4级xxx分
        \item 英语水平-CET6级xxx分
        \item 计算机几级证书
